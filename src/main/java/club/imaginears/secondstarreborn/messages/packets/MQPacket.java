package club.imaginears.secondstarreborn.messages.packets;
...
public abstract class MQPacket {
    ...
    public byte[] toBytes() {
        ...
        if (obj != null) return obj.toString().getBytes(StandardCharsets.UTF_8);
            ...
            SecondStar.getProxyServer().getLogger().severe("JSON Object for packet is null! " + this.getClass().getName());
            return new byte[0];
        }
    }
}